...
export const cancionesIniciales = [
  ...
  { id: uuidv4(), nombre: 'Lose Yourself', artista: 'Eminem', album: '8 Mile', genero: 'Hip-Hop', anio: 2002, imagen: 'https://upload.wikimedia.org/wikipedia/en/9/98/Eminem_-_Lose_Yourself.jpg', archivo: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-3.mp3', activo: true },
  { id: uuidv4(), nombre: 'Shape of You', artista: 'Ed Sheeran', album: 'Divide', genero: 'Pop', anio: 2017, imagen: 'https://upload.wikimedia.org/wikipedia/en/3/35/Ed_Sheeran_-_%C3%B7.png', archivo: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-4.mp3', activo: true },
