...
export const cancionesIniciales = [
  {
    ...
    genero: 'Rock',
    anio: 1975,
    imagen: 'https://upload.wikimedia.org/wikipedia/en/4/4d/Queen_A_Night_At_The_Opera.png',
  ...
  },
  {
    ...
    genero: 'Pop',
    anio: 2010,
    imagen: 'https://upload.wikimedia.org/wikipedia/en/1/1b/Adele_-_21.png',
  ...
  },
  {
    ...
    genero: 'Reggaeton',
    anio: 2017,
    imagen: 'https://cdn-images.dzcdn.net/images/cover/7985ef4ccd9e66af2fc3c18d629689aa/1000x1000-000000-80-0-0.jpg',
  ...
  },
  {
    ...
    genero: 'Disco',
    anio: 1977,
    imagen: 'https://cdn-images.dzcdn.net/images/cover/062e4071ebfc701e5f1ca935e69a0b5b/1000x1000-000000-80-0-0.jpg',
  ...
  },
  {
    ...
    genero: 'Pop',
    anio: 2019,
    imagen: 'https://upload.wikimedia.org/wikipedia/en/3/38/When_We_All_Fall_Asleep%2C_Where_Do_We_Go%3F.png',
  ...
  },
  {
    ...
    genero: 'Salsa',
    anio: 2013,
    imagen: 'https://cdn-images.dzcdn.net/images/cover/704472d2cb6d5e71fc79f424f83d1956/1000x1000-000000-80-0-0.jpg',
...
export const usuariosIniciales = [
  ...
  },
  {
    id: 'admin-ivan',
    nombre: 'Iván',
    email: 'adminIvan@nibmusic.com',
    password: 'admin123',
    rol: 'admin',
    avatar: 'https://ui-avatars.com/api/?name=Ivan&background=6d28d9&color=fff',
    fechaRegistro: new Date().toISOString(),
    activo: true,
    fechaDesactivacion: null,
  },
  {
    id: 'admin-nico',
    nombre: 'Nico',
    email: 'adminNico@nibmusic.com',
    password: 'admin123',
    rol: 'admin',
    avatar: 'https://ui-avatars.com/api/?name=Nico&background=6d28d9&color=fff',
    fechaRegistro: new Date().toISOString(),
    activo: true,
    fechaDesactivacion: null,
  },
  {
    id: 'admin-fede',
    nombre: 'Fede',
    email: 'adminFede@nibmusic.com',
    password: 'admin123',
    rol: 'admin',
    avatar: 'https://ui-avatars.com/api/?name=Fede&background=6d28d9&color=fff',
    fechaRegistro: new Date().toISOString(),
    activo: true,
    fechaDesactivacion: null,
  },
